...
<html>
<head>
    <title>Section & Year Level</title>
...
<h2 class='table-title'>Section & Year Level</h2>
    ...
    <tbody>
        ...
        if ($result && $result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                $year_display    = htmlspecialchars($row['year_level'], ENT_QUOTES);

                $section_attr = htmlspecialchars($row['section'], ENT_QUOTES);
                $year_attr    = htmlspecialchars($row['year_level'], ENT_QUOTES);
...
<div id="edit-modal" class="modal-overlay hidden">
    <div class="modal-box">
        ...
        <form id="edit-section-form">
            ...
            <label>Year Level</label>
            <input type="text" id="edit-year-level" name="year_level" required>
